...
import { agents as agentsTable, companies, heartbeatRuns } from "@crewdeck/db";
...
import { runClaudeLogin } from "@crewdeck/adapter-claude-local/server";
import {
...
export function agentRoutes(db: Db) {
  ...
  const strictSecretsMode = process.env.CREWDECK_SECRETS_STRICT_MODE === "true";
