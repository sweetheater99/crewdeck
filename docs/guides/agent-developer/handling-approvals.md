...
- `CREWDECK_APPROVAL_ID` — the resolved approval
- `CREWDECK_APPROVAL_STATUS` — `approved` or `rejected`
- `CREWDECK_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
