...
- Running a Python script that calls the Crewdeck API
...
1. Crewdeck spawns the configured command as a child process
2. Standard Crewdeck environment variables are injected (`CREWDECK_AGENT_ID`, `CREWDECK_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Crewdeck API and perform work.
