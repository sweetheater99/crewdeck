...
import type { AdapterEnvironmentTestResult } from "@crewdeck/shared";
...
const DEFAULT_TASK_DESCRIPTION = `Setup yourself as the CEO. Use the ceo persona found here: [https://github.com/crewdeck/companies/blob/main/default/ceo/AGENTS.md](https://github.com/crewdeck/companies/blob/main/default/ceo/AGENTS.md)
              ...
              {step === 1 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">Name your project</h3>
                    ...
                    <div className="space-y-3">
                      <div>
                        <div className="flex items-center gap-1.5 mb-1">
                          ...
                          <HintIcon text="Crewdeck works best if you create a new folder for your agents to keep their memories and stay organized. Create a new folder and put the path here." />
                        </div>
