...
import { buildProjectMentionHref, parseProjectMentionHref } from "@crewdeck/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("crewdeck-project-mention-chip");
      ...
      link.classList.add("crewdeck-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative crewdeck-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("crewdeck-mdxeditor", !bordered && "crewdeck-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "crewdeck-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
