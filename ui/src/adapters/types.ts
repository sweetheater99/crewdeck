...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@crewdeck/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@crewdeck/adapter-utils").TranscriptEntry[];
