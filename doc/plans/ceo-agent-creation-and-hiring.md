...
- installed adapter list for this Crewdeck instance
...
## 8. New Skill: `crewdeck-create-agent`

Create new skill directory:

- `skills/crewdeck-create-agent/SKILL.md`
...
Also update `skills/crewdeck/SKILL.md` to reference this skill for hiring workflows.
...
- `crewdeck-create-agent` skill + docs updates
